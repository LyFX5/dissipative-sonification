...
class GrayScott:
    ...
    def step(self):
        ...
        self.V += cfg.DT * (cfg.DV * lap_V + reaction - (self.f + self.k) * self.V)
    ...
    def get_metrics(self):
        ...
        entropy = -np.sum(prob * np.log2(prob + 1e-12)) / np.log2(32)  # normalized [0,1]
        ...
        return {
            "f": self.f, "k": self.k, "v_mean": v_mean,
            "v_row": v_row, "entropy": entropy,
